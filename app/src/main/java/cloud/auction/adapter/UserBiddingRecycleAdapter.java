...
public class UserBiddingRecycleAdapter extends RecyclerView.Adapter<UserBiddingRecycleAdapter.CurrentBiddingViewHolder> {
    private List<Bid> listBids;
    private Activity activity;
    private long timeCount;
    private ObjectMapper om = new ObjectMapper();
    public UserBiddingRecycleAdapter(List<Bid> listBids, Activity activity) {
    ...
    @NonNull
    @Override
    public CurrentBiddingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View item = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_current_bidding_items, parent, false);
        return new CurrentBiddingViewHolder(item);
    }

    @Override
    public void onBindViewHolder(@NonNull final CurrentBiddingViewHolder holder, int position) {
...
//        });
    ...
    class CurrentBiddingViewHolder extends RecyclerView.ViewHolder {
        ...
        public CurrentBiddingViewHolder(@NonNull View itemView) {
            super(itemView);
